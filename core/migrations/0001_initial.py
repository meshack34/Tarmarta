    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('agent', 'Agent'), ('manager', 'Manager')], default='agent', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('promo', 'Promotion'), ('sampling', 'Sampling'), ('discount', 'Discount'), ('event', 'Event')], default='promo', max_length=32)),
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('active', 'Active'), ('paused', 'Paused'), ('completed', 'Completed'), ('cancelled', 'Cancelled')], default='draft', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['pack', 'effective_from', 'effective_to'], name='core_pricel_pack_id_20ee1e_idx')],
            },
        ),
